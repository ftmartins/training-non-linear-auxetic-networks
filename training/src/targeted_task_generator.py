...
TARGETED_TASKS = [
    ...
    # Tasks 16-23: same (compression_strains, task structure) as tasks 0-7,
    # with all target_poisson_ratios divided by 4.
    {
        'task_seed': 16,
        'packing_seed': PACKING_SEED,
        'n_nodes': N_TARGETED_NODES,
    ...
    },
    {
        ...
        'n_strain_steps': N_STRAIN_STEPS,
        'compression_strains': [-0.2, -0.1],
        'target_poisson_ratios': [-0.2, -0.25],
    },
    {
        'task_seed': 19,
        'packing_seed': PACKING_SEED,
    ...
    },
    {
        ...
        'n_strain_steps': N_STRAIN_STEPS,
        'compression_strains': [-0.2, -0.1],
        'target_poisson_ratios': [-0.2, -0.15],
    },
    {
        'task_seed': 21,
        'packing_seed': PACKING_SEED,
        ...
        'n_strain_steps': N_STRAIN_STEPS,
        'compression_strains': [-0.2, -0.1],
        'target_poisson_ratios': [-0.2, -0.075],
    },
    {
        'task_seed': 22,
        'packing_seed': PACKING_SEED,
        ...
        'n_strain_steps': N_STRAIN_STEPS,
        'compression_strains': [-0.2, -0.1],
        'target_poisson_ratios': [-0.2, -0.125],
    },
    {
        'task_seed': 23,
        'packing_seed': PACKING_SEED,
        ...
        'n_strain_steps': N_STRAIN_STEPS,
        'compression_strains': [-0.2, -0.1],
        'target_poisson_ratios': [-0.2, -0.05],
    },
]
